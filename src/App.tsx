...
function ContentSection2({sectionTitle,children}:{sectionTitle:string,children:ReactNode}) {
  ...
  return (
    <div style={sectionStyle}>
      <h3 style={{ fontWeight: 700 }}>{sectionTitle}</h3>
    ...
    <>
      <Layout style={layoutStyle}>
        ...
        <Content style={contentStyle}>
          <ContentSection1>
            <h2 className="section-title">欢迎报考</h2>
